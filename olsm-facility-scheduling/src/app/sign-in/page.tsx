      ...
      <div className="mx-auto max-w-md space-y-4">
        <Card title="Sign in">
          {ssoConfigured() ? (
            ...
            <p className="mb-4 rounded border border-navy-200 bg-navy-50 p-3 text-xs text-navy-700">
              Google Workspace sign-in is not configured in this environment. Staff can sign in with
        ...
        <Card title="Outside organisation?">
